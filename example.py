#!/usr/bin/env python
# rename to zilliqa.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/zilliqa/")
...
print("zilliqa $" + str(usd) + " | iconName=invest-applet")
print("---")
