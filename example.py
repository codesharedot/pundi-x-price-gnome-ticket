#!/usr/bin/env python
# rename to pundi-x.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/pundi-x/")
...
print("pundi-x $" + str(usd) + " | iconName=invest-applet")
print("---")
